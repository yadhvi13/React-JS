...
import useCurrencyList from './CustomHooks/useCurrencyList'
...
function App() {
  ...
  //returning key and its values for currency
  const options = Object.keys(currencyList)

  //swap krne ke liye usd se inr, vice-versa and many more
  const swap = () => {
    setFrom(to)
    setTo(from)
      ...
      <div className="w-full">
          <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
              ...
              >
                  ...
                  <button type="submit" className="w-full bg-blue-800 hover:bg-blue-700 text-white px-4 py-3 rounded-lg cursor-pointer">
